...
{
    public class IGenericService<DtoAdd, DtoUpdate, DtoGet, T> : IBaseServiceGeneric<DtoAdd, DtoUpdate, DtoGet, T>
        where DtoAdd : class
        ...
        where T : class
    {
        ...
        public IGenericService(IMapper mapper, IBaseRepository<T> repository)
        {
